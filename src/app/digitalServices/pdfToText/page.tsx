            ...
            {!selectedFile ? (
              ...
              <div className="w-full flex flex-col items-center justify-center gap-2">
                <embed
                  ...
                  className="w-full h-[420px] rounded-lg border border-neutral-700 bg-neutral-900"
                  onLoad={(e) =>
                    URL.revokeObjectURL((e.target as HTMLObjectElement).data)
                  }
                />
        ...
        <div className="flex flex-col items-center justify-center w-14 relative">
          ...
          {/* <button
            ...
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2
              bg-blue-700 hover:bg-blue-800 text-white rounded-full p-3 shadow-lg flex flex-col items-center group
